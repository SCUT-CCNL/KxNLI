...
from snli_data import MHDataset
...
def train(args, train_dataset, model, tokenizer):
    ...
    for epoch in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            loss, gen_loss, gate_loss = outputs
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    logger.info(
                        "Step: {} | Loss: {:.4f} | Gen loss: {:.4f} | Gate Loss: {:.4f} ".format(
                            global_step, (tr_loss - logging_loss) / args.logging_steps, gen_loss.item(),
                            gate_loss.item()))
            ...
            if (step + 1) % args.validate_steps == 0:
                ...
                if args.save_last or (result[args.evaluate_metrics] - best_valid[args.evaluate_metrics]) * sign_list[
...
def main():
    ...
    ## File parameters
    dataType = 'snli'
    parser.add_argument("--train_data_file", default='../data/' + dataType + '/train', type=str,
                        help="The input training data file (a text file).")
    parser.add_argument("--dev_data_file", default='../data/' + dataType + '/dev', type=str, )
    parser.add_argument("--test_data_file", default='../data/' + dataType + '/test', type=str, )
    parser.add_argument("--output_dir", default='../models/' + dataType + '/att-medium-withRational-' + dataType, type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--graph_path", default='2hops_100_directed_triple_filter_triple_label_HE.json', type=str)

    ## My parameters
    parser.add_argument("--source_length", default=64, type=int)
    parser.add_argument("--target_length", default=32, type=int)
    parser.add_argument("--tb_log_dir", default=None, type=str)
    parser.add_argument("--evaluate_metrics", default='bleu', type=str, help='choose between ppl and bleu')

    parser.add_argument("--model_type", default="gpt2", type=str,
                        help="The model architecture to be fine-tuned.")
    parser.add_argument("--model_name_or_path", default="../models/gpt2-medium", type=str,
    ...
    parser.add_argument("--save_last", default=True, action='store_true')
    ...
    parser.add_argument('--gradient_accumulation_steps', type=int, default=1,
                        help="Number of updates steps to accumulate before performing a xbackward/update pass.")
