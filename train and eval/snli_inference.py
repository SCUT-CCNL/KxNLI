                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    logger.info(
                        "Step: {} | Loss: {:.4f} | Gen loss: {:.4f} | Gate Loss: {:.4f} | Triple Loss: {:.4f}".format(
                            ...
                            gate_loss.item(), triple_loss.item()))
...
def save_generation(args, results, prefix='0'):
    ...
    save_result_dir = os.path.join(args.output_dir, "222222_{}.txt".format(prefix))
...
def main():
    ...
    parser.add_argument("--output_dir", default='../models/' + dataType + '/att-medium-withR-' + dataType, type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--graph_path", default='2hops_100_directed_triple_filter_triple_label_HE.json', type=str) # SNLI
    ...
    parser.add_argument("--model_name_or_path", default="../models/gpt2-small", type=str,
    ...
    parser.add_argument("--per_gpu_train_batch_size", default=8, type=int,
                        help="Batch size per GPU/CPU for trainng.")
    ...
    if args.do_eval:
        evaluate(args, model, tokenizer, args.evaluate_metrics, 'dev')
        evaluate(args, model, tokenizer, args.evaluate_metrics, 'test')
        evaluate(args, model, tokenizer, args.evaluate_metrics, 'train')
